...
export default function BenefitsSection() {
  return (
    <section className="w-full my-10 md:my-14 lg:my-20 xl:my-[120px] overflow-x-hidden">
          ...
          <div className=" rounded">
            <div className="mb-4">
              <Image
                ...
                width={50}
                height={50}
                className="hover:scale-125 animate-jump transition-all duration-300"
              />
            </div>
          ...
          <div className=" rounded ">
            <div className="mb-4">
              <Image
                ...
                width={50}
                height={50}
                className="hover:scale-125 animate-float transition-all duration-300"
              />
            </div>
            <AnimatedContent direction="horizontal" reverse={false}>
              <h3 className="text-xl font-semibold text-blue-900 mb-2">
