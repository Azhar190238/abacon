  ...
  return (
   ...
   <CommonHeader heading="Privacy Policy" />
    <div className="bg-white text-gray-800 px-6 py-12 container mx-auto space-y-6">
      ...
      <section>
        <h2 className="text-2xl font-semibold mt-8">Types of Data Collected</h2>
      ...
      <section>
        <h2 className="text-2xl font-semibold mt-8">Tracking Technologies and Cookies</h2>
      ...
      {/* Sharing Your Data */}
      <section>
        <h2 className="text-2xl font-semibold mt-8">Sharing Your Personal Data</h2>
        <ul className="list-disc list-inside space-y-1">
